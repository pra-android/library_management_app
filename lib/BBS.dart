...
import 'package:library_management_app/BBSDatabase.dart';
...
class _BBSState extends State<BBS> {
  ...
  Future<void> fetchmodelfromDatabase() async {
    List<Model> model = await BBSDataBaseHandler.instance.bbsdisplaymodel();
    setState(() {
      allmodels = model;
  ...
  void _onsave() async {
    ...
    await BBSDataBaseHandler.instance.bbsinsertmodel(model);
  ...
  void bbsdeletemodel(int id) async {
    await BBSDataBaseHandler.instance.bbsdeletemodel(id);
    fetchmodelfromDatabase();
