...
import 'package:library_management_app/BHMDatabase.dart';
...
class _BHMState extends State<BHM> {
  ...
  Future<void> fetchmodelfromDatabase() async {
    List<Model> model = await BHMDataBaseHandler.instance.bhmdisplaymodel();
    setState(() {
      allmodels = model;
  ...
  void _onsave() async {
    ...
    await BHMDataBaseHandler.instance.bhminsertmodel(model);
  ...
  void bhmdeletemodel(int id) async {
    await BHMDataBaseHandler.instance.bhmdeletemodel(id);
    fetchmodelfromDatabase();
