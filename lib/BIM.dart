...
import 'package:library_management_app/BIMDatabase.dart';
...
class _BIMState extends State<BIM> {
  ...
  Future<void> fetchmodelfromDatabase() async {
    List<Model> model = await BIMDataBaseHandler.instance.bimdisplaymodel();
    setState(() {
      allmodels = model;
  ...
  void _onsave() async {
    ...
    await BIMDataBaseHandler.instance.biminsertmodel(model);
  ...
  void bimdeletemodel(int id) async {
    await BIMDataBaseHandler.instance.bimdeletemodel(id);
    fetchmodelfromDatabase();
